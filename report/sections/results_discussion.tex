...
Before presenting the findings on the interface and numerical aspects, the chapter describes 
what was validated and how it was implemented.The validation has two parts: (i) a controlled 
machine-learning protocol with fixed data splits and shared evaluation code, and (ii) a 
practical software check that the integrated services run together as a working system.
...
after expanding to 30 species, and finally qualitative evidence from the implemented web interface.
...
This subsection interprets BirdSight's results in project-specific terms: how the InceptionV3 metrics 
and the implemented platform relate to the research questions, how key design choices connect to the 
cited literature, and which limitations remain honest. The following subsubsections take these points 
in order and end with a short takeaway.
