            ...
            return (
              ...
              >
                ...
                <div className="flex-1 w-full lg:w-1/2 relative z-10 pl-16 lg:pl-0">
                  {/* Mobile step dot */}
                  <div className={`absolute left-0 top-1 w-8 h-8 rounded-full border-4 border-stone-50 bg-emerald-500 flex items-center justify-center lg:hidden`}>
                     <span className="text-white text-xs font-bold">{step.step}</span>
                  </div>

                  <div className={`flex flex-col gap-4 max-w-sm ${isEven ? 'lg:ml-auto' : ''}`}>
                    {/* Icon & Step Badge */}
                    <div className="hidden lg:flex items-center gap-3">
                      <div className={`w-12 h-12 rounded-2xl flex items-center justify-center shrink-0 ${step.accent} shadow-sm`}>
