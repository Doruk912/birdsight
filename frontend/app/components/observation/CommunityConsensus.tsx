...
export default function CommunityConsensus({identifications }: CommunityConsensusProps) {
  const activeIdentifications = identifications.filter(i => i.current && !i.withdrawn);
  ...
  return (
    <div className="bg-white rounded-2xl border border-stone-200 shadow-sm p-5 animate-fade-in-up-delay-3">
      <h3 className="text-sm font-semibold text-stone-800 mb-4">Community Taxon</h3>
